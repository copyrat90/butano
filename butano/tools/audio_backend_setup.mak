...
# Synced audio setup:
#---------------------------------------------------------------------------------------------------------------------
ifneq ($(strip $(DMGAUDIOSYNC)),)
#---------------------------------------------------------------------------------------------------------------------
    BN_AUDIO_BACKEND_CFLAGS	+=	-DBN_DMG_AUDIO_SYNC

ifneq ($(strip $(AUDIOBACKEND)),maxmod)
    $(error "DMG audio sync requires audio backend: maxmod")
endif

ifneq ($(strip $(DMGAUDIOBACKEND)),default)
    $(error "DMG audio sync requires DMG audio backend: default")
endif
#---------------------------------------------------------------------------------------------------------------------
endif
